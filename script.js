require([
  ...
  // ---- ADDED MODULES (for loading province JSON) ----
  ...
  // ---- MATCHING VARIABLES FOR NEW MODULES ----
  GraphicsLayer,
  Polygon,
  SimpleFillSymbol,
  SimpleLineSymbol,
  ...
  map.on('load', function() {
    ...
    // ==========================================================
    // NEW SECTION: LOAD AFGHANISTAN PROVINCES FROM province.json
    // ==========================================================

    var provinceLayer = new GraphicsLayer();  // layer for province borders
    ...
    function createGraphicsFromCsv(csvFilePath, canvasLayer) {
      Papa.parse(csvFilePath, {
        ...
        complete: function(results) {
          ...
          // =====================================================
          // EXISTING SECTION: FMP CHECKBOX FILTER
          // =====================================================
